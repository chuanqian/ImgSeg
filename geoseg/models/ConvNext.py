...
from geoseg.models.ConvBase import Conv, ConvBN, ConvBNReLU, SeparableConv, SeparableConvBNReLU, SeparableConvBN, WF
...
if __name__ == '__main__':
    model = ConvNextBackbone(num_classes=6, decode_channels=96)

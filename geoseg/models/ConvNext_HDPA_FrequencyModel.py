...
from geoseg.models.learnable_frequency_modeling import HierarchicalDualPathAttention, dynamic_filter


class ConvNextHDPAFrequencyModel(nn.Module):
    def __init__(self,
                 num_classes=6,
    ...
    def forward(self, x):
        ...
        feat = channels_feat + spatial_feat
...
if __name__ == '__main__':
    model = ConvNextHDPAFrequencyModel(num_classes=6, decode_channels=96)

...
from geoseg.models.learnable_frequency_modeling import HierarchicalDualPathAttention


class ConvNextHDPA(nn.Module):
    def __init__(self,
                 num_classes=6,
    ...
    def forward(self, x):
        ...
        feat = middle_feat + channels_feat
...
if __name__ == '__main__':
    model = ConvNextHDPA(num_classes=6, decode_channels=96)

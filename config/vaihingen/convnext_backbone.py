...
from geoseg.models.ConvNext import ConvNextBackbone
...
weights_name = "convnext_backbone-r18-512-crop-ms-e105"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "convnext_backbone-r18-512-crop-ms-e105"
...
#  define the network
net = ConvNextBackbone(num_classes=num_classes)

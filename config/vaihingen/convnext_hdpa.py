...
from geoseg.models.ConvNext_HDPA import ConvNextHDPA
...
weights_name = "ConvNextHDPA-r18-512-crop-ms-e105"
weights_path = "model_weights/vaihingen/{}".format(weights_name)
test_weights_name = "ConvNextHDPA-r18-512-crop-ms-e105"
...
#  define the network
net = ConvNextHDPA(num_classes=num_classes)
